...
> [!IMPORTANT]
> Si vous souhaitez tester et déployer l'infrastructure du projet en local, veuillez vous référer au document dédié : [`MANUEL_UTILISATION.md`](./MANUEL_UTILISATION.md).
